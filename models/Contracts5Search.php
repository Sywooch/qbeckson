 ...
 */
class Contracts5Search extends Contracts
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'number', 'status', 'status_year', 'organization_id'], 'integer'],
            [['date', 'status_termination', 'status_comment', 'link_doc', 'link_ofer', 'start_edu_programm', 'start_edu_contract', 'stop_edu_contract', 'certificatenumber', 'payersname', 'programname', 'yearyear', 'date_termnate'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
       ...
       // $organization = $organizations->getOrganization();
        ...
        $query->andFilterWhere(['like', 'status_comment', $this->status_comment])
            ...
            ->andFilterWhere(['like', 'date_termnate', $this->date_termnate])
