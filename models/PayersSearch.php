...
class PayersSearch extends Payers
{
    ...
    {
        return [
            [['id', 'user_id', 'OGRN', 'INN', 'KPP', 'OKPO', 'mun', 'directionality_1_count', 'directionality_2_count', 'directionality_3_count', 'directionality_4_count', 'directionality_5_count', 'directionality_6_count'], 'integer'],
            [['name', 'address_legal', 'address_actual', 'phone', 'email', 'position', 'fio', 'directionality'], 'safe'],
        ];
    }
