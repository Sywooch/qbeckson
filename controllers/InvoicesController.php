...
//return var_dump($contract);
    ...
    public function actionCountpayer()
    {
     ...
     public function actionMpdf($id) {
        ...
        <tr>
            <td >Руководитель<br><br>_________________/_________________/<br>М.П.</td>
            <td >Главный бухгалтер<br><br>_________________/_________________/</td>
        </tr>
        </table>';
    ...
    // }
        ...
        <tr>
            <td >Руководитель<br>_________________/_________________/<br>М.П.</td>
            <td >Главный бухгалтер<br>_________________/_________________/</td>
        </tr>
        </table>';
