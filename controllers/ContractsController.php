...
EOD;
        ...
        if ($program->year >= 2 and $program->year <= 4) {
            $text144 = 'Полный срок реализации Программы - ' . $program->year . ' года.';
        }
        if ($program->year >= 5) {
            $text144 = 'Полный срок реализации Программы - ' . $program->year . ' лет.';
        }
        if ($program->year == 1) {
