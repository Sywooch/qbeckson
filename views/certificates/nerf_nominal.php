...
<div class="certificates-update" ng-app>
    ...
    <?= Html::label(Html::checkbox(null, null, ['id' => 'check-enshure', 'ng-model' => 'enshure']) . 'Внимание! Установление номинала сертификата, отличного от предусмотренного программой ПФ, требует согласия родителя (законного представителя) ребенка. Нажимая на галочку, Вы подтверждаете, что решение установления иного номинала продумано и согласовано.', 'check-enshure') ?>
