                        ...
                        if (Yii::$app->user->can('certificate')) {
                            ...
                            if ($cooperate != 0) {
                                ...
                                if ($value->open == 0) {
                                    ...
                                    if (($certificate->balance < 1 && $certificate->certificate_can_use_future_balance < 1) || ($certificate->balance < 1 && $certificate->certificate_can_use_future_balance > 0 && $certificate->balance_f < 1)) {
