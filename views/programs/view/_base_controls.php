...
<div class="btn-row">
    <?php if (Yii::$app->user->can(\app\models\UserIdentity::ROLE_OPERATOR)) {
        echo Html::a('К списку программ', '/personal/operator-programs', ['class' => 'btn btn-danger']);
    ...
    if (Yii::$app->user->can(\app\models\UserIdentity::ROLE_PAYER)) {
        echo Html::a('К списку программ', '/personal/payer-programs', ['class' => 'btn btn-danger']);
    }

    if (Yii::$app->user->can(\app\models\UserIdentity::ROLE_ORGANIZATION)) {
        echo Html::a('К списку программ', '/personal/organization-programs', ['class' => 'btn btn-danger']);
