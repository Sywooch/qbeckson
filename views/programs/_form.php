...
<div class="programs-form"  ng-app>
    ...
    <?php $form = ActiveForm::begin(['id' => 'dynamic-form', 'options' => ['enctype' => 'multipart/form-data']]); ?>
        ...
        <?php /* $form->field($model, 'certification_date')->widget(DateControl::classname(), [
    ...
    ?>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4>Количество лет реализации программы</h4>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <?php /* FieldRange::widget([
                                            'form' => $form,
                                            'model' => $modelYears,
                                            'label' => 'Ожидаемое минимальное и максимальное число детей, обучающееся в одной группе',

                                            'attribute1' => "[{$i}]minchild",
                                            'attribute2' => "[{$i}]maxchild",
                                            'type' => FieldRange::INPUT_SPIN,
                                            'separator' => 'до',
                                             'fieldConfig1' => ['addon'=>[
                                                'prepend' => ['content'=>'От '], 
