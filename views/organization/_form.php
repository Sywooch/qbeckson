...
<div class="organization-form" ng-app>
    ...
    <div class="well">
    <small>Банковские реквизиты</small><br><br>
    ...
    <?= $form->field($model, 'okopo')->textInput(!isset($roles['operators']) ? ['readOnly'=>true] : ['maxlength' => true]) ?>
        
    <?= $form->field($model, 'last')->textInput(['maxlength' => true]) ?>
        
    <?php // $form->field($model, 'last')->textInput(!$model->isNewRecord ? ['readOnly'=>true] : ['maxlength' => true]) ?>
