...
<div class="news-index">
    ...
    <p>
        <?= Html::a(Yii::t('db_rbac', 'Добавить роль'), ['/permit/access/add-role'], ['class' => 'btn btn-success']) ?>
    </p>
<?php
            ...
            'buttons' =>
                [
                    ...
                    'delete' => function ($url, $model) {
                                return Html::a('<span class="glyphicon glyphicon-trash"></span>', Url::toRoute(['/permit/access/delete-role','name' => $model->name]), [
