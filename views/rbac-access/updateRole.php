...
$this->params['breadcrumbs'][] = ['label' => Yii::t('db_rbac', 'Управление ролями'), 'url' => ['/permit/access/role']];
...
<div class="news-index">
    ...
    <div class="links-form">
        ...
        <div class="form-group">
            <?= Html::label(Yii::t('db_rbac', 'Текст страницы помощи')); ?><br />
            <?= Html::textarea('data', $role->data, ['rows' => 12, 'cols' => 100]); ?>
        </div>
