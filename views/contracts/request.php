                        ...
                        <div class="panel-body">
                            ...
                            <div style="display: none;">
                                ...
                                <?php if (!$cooperateWithCorrespondingPeriodExists): ?>
                                    ...
                                    <p>Вы выбрали для обучения период, на который у поставщика услуг пока нет формализованных оснований для формирования оферты. Это простая бюрократическая процедура, но она должна быть исполнена прежде чем он сможет выставить Вам оферту на заключение договора. Нажмите кнопку "продолжить" для перехода к окну подтверждения подачи заявки</p>
