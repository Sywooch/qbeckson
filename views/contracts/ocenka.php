    ...
    <div class="well">
        <p>Организацией, реализующей программу, заявлены следующие ее цели и задачи:
            ...
            <?php if (!empty($model->year->results)): ?>
                <strong>Ожидаемые результаты модуля:</strong> <?= Html::encode($model->year->results) ?>.
                <br/>
                <br/>
            <?php endif; ?>
            Оцените, пожалуйста, насколько, по Вашему мнению организация стремится при реализации программы достигнуть
            указанные цели и задачи.
        </p>
        <br>
        <br>
