    ...
    <div class="container-fluid">
        <div class="top-line row">
            <div class="col-md-10 col-md-offset-1 text-center">
                <a href="<?= Url::home() ?>">Портал персонифицированного финансирования дополнительного образования
                    детей</a>
            </div>
            <div class="col-md-1">
                <?php
            ...
            <div class="col-md-12">
                ...
                if (Yii::$app->user->can('certificate')) {
                    ...
                    if ($certificate->actual == 0) {
                        ...
                        $items = [
                            ['label' => 'Сертификат учёта <span class="glyphicon glyphicon-user"></span>', 'url' => ['/personal/certificate-info']],
                        ];
                    } else {
                        $items = [
