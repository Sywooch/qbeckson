                        ...
                        [
                            'favorites' => function ($url, $model) {
                                ...
                                $rows = (new \yii\db\Query())
                                    ...
                                    ->one();
                                if (!$rows) {
                                    return Html::a('<span class="glyphicon glyphicon-star-empty"></span>', Url::to(['/favorites/new', 'id' => $model->program->id]), [
                                        'title' => Yii::t('yii', 'Добавить в избранное')
                                    ]);
                                } else {
                                    return Html::a('<span class="glyphicon glyphicon-star"></span>', Url::to(['/favorites/terminate', 'id' => $model->program->id]), [
