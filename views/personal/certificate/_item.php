...
<div class="card" <?= ($isAvailable ? '' : 'style="background-color: bisque;" 
      data-placement="top" data-toggle="tooltip"
                             title="Вы не можете записаться на данную программу по '
    . 'одной или нескольким причинам, нажмите \'подробнее\' что бы уточнить."') ?> >
    <div class="row">
            ...
            <div class="card-info">
                ...
                <div class="card-info-paragraph card-info-paragraph_mh38">
                    ...
                    <div class="adaptive-ib" data-placement="top" data-toggle="tooltip"
                         title="Стоимость модуля и нормативная стоимость модуля (НС)
                          для программ с несколькими модулями указаны в таблице для первого модуля.">
                        <?= $fStrings['costFirstModule'] ?>
                    </div>
                    <div class="adaptive-ib" data-placement="top" data-toggle="tooltip"
                         title="Стоимость модуля и нормативная стоимость модуля (НС) для программ
                         с несколькими модулями указаны в таблице для первого модуля.">
                        <?= $fStrings['costFirstModuleNotmativ'] ?>
                    </div>
                </div>
                <?= Html::a(
                    'Просмотр',
                    ['programs/view', 'id' => $model->id],
