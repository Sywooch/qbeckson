...
<div class="tab-content">
    ...
    <div id="panel2" class="tab-pane fade">
        ...
        <?php endif; ?>
        <?php if ($searchFutureContracts->certificate_id) : ?>
            <p class="lead">Показаны результаты для сертификата: <?= $searchFutureContracts->certificateNumber; ?></p>
        <?php endif; ?>
    ...
    <p>
        ...
        if ($doc = \app\models\ContractDocument::findByPayer($payer, date('Y'), date('m'))) {
            ...
            $searchLastMonthContracts = new ContractsPayerInvoiceSearch([
                'payer_id' => $payer->id,
                'lastMonth' => true,
                'excludeContracts' => $docLastMonth ? $docLastMonth->contract_list : null,
            ]);
