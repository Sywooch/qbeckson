...
<div class="password-reset">
    ...
    <p>Вы можете отслеживать статус заявки по ссылке <?= Html::a(Html::encode($updateLink), $updateLink) ?> или запомнить и использовать номер заявки <span style="color: yellow;"><?= $model->anonymous_update_token ?></span> для ее поиска </p>
