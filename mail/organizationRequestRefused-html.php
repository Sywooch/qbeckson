...
<div class="password-reset">
    ...
    <p style="color: yellow;"><?= $model->refuse_reason ?></p>
    <p>Если Вы в силах устранить причину отклонения заявки – отредактируйте ее, перейдя по ссылке <?= Html::a(Html::encode($updateLink), $updateLink) ?> или найдя ее по номеру заявки <span style="color: yellow;"><?= $model->anonymous_update_token ?></span></p>
