...
class m170728_092020_add_operator_cooterate_search_filters extends Migration
{
    public function safeUp()
    {
        $this->insert('settings_search_filters', [
            ...
            'table_columns' => 'number,date,payerName,payerMunicipality,contractsCount',
            'inaccessible_columns' => 'number,payerMunicipality,organizationName,organization_id,payer_id',
            'is_active' => 1,
